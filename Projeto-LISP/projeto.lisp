...
(progn
  ...
  (format t "& Luis Mestre, 140221002. Este projeto será um teste de algoritmos e da~%")
...
;; load-files
;diretorio - "C:/Users/luism/Desktop/EI/3º Ano/1º Semestre/IA/Projeto/Projeto-LISP/"
(defun load-files()
"Load-files é um metodo que fará a leitura dos ficheiros com os metodos de procura, dos algoritmos e dos restantes operadores"
(progn
...
"Funcao auxiliar a funcao ler-tabuleiro-ficheiro"
  (progn
    ...
    (let* ((lista-tabuleiros (read (open f))) (escolha (read)) (tabuleiro-escolhido (escolher-tabuleiro lista-tabuleiros escolha)))
      (cond
       ((null tabuleiro-escolhido) (progn (format t "O tabuleiro que escolheu não existe~%") (ler-tabuleiro-ficheiro-aux f)))
...
;; Output ecrã e no ficheiro - escrita do estado do problema
;; escreve
